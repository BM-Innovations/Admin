...
export default Model.extend(Comparable, ValidationEngine, {
    ...
    shareOnFacebook: attr('boolean', {defaultValue: false}),
    shareOnInstagram: attr('boolean', {defaultValue: false}),
    shareOnLinkedin: attr('boolean', {defaultValue: false}),
    shareOnTwitter: attr('boolean', {defaultValue: false}),
    socialShareImage1: attr('string'),
    socialShareImage2: attr('string'),
    socialShareImage3: attr('string'),
    socialShareImage4: attr('string'),
